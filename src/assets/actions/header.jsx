...
export default function Header() {
  ...
  return (
    <>
            ...
            >
              ...
              >
                <div className="avatar-wrapper-with-caret">
                  {/* 🌟 Verificação direta usando a propriedade camelCase que vem do seu useAuth */}
                  {user?.avatarUrl ? (
                    <img
                      src={user.avatarUrl}
                      alt="Perfil"
      ...
      {/* Sidebar mobile */}
      <aside
        className={`mobile-sidebar ${menuMobileAberto ? "mobile-sidebar--open" : ""}`}
      >
        ...
        {logado && (
          <div className="mobile-sidebar__user">
            <div className="mobile-avatar">
              {/* 🌟 Verificação direta também no ambiente mobile */}
              {user?.avatarUrl ? (
                <img
                  src={user.avatarUrl}
                  alt="Perfil"
            ...
            <div>
              <p className="mobile-user-nickname">
                {user?.nickname || "Jogador"}
              </p>
        ...
        <nav className="mobile-sidebar__nav">
          <button className="mobile-nav-item" onClick={() => navegar("/games")}>
            🎮 Explorar Jogos
          </button>
          <button
            className="mobile-nav-item"
            onClick={() => navegar("/players")}
          >
            🔍 Encontrar Jogadores
          </button>
          ...
          {!logado && (
            <>
              <hr className="mobile-sidebar__divider" />
              <button
                className="mobile-nav-item mobile-nav-item--accent"
